...
all_data_for_regr <- beverages_regression_df %>% rbind(energy_regression_df) 
...
Appendix 1: Readability analysis with FOG measures for all three industry samples
