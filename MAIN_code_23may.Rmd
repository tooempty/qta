...
The average FOG score for our sample of 27 fashion companies from the US is `r round(mean(energy_rd_fog$FOG), digits = 2)`.
...
The average FOG score for our sample of 27 fashion companies from the US is `r round(mean(bev_rd_fog$FOG), digits = 2)`.
